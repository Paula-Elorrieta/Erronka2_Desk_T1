...
public class Reuniones implements java.io.Serializable {
	...
	public Reuniones(Integer idReunion, String estado, Users usersByProfesorId, String idCentro, String titulo, String asunto, String aula,
			Date fecha) {
		...
		this.asunto = asunto;
		this.aula = aula;
	    this.fecha = fecha != null ? new Timestamp(fecha.getTime()) : null;
	}
