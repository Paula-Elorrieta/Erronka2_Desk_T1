...
public class IrakasleenOrduakV extends JFrame {
	...
	public IrakasleenOrduakV() {
		...
		tableHorarios.setModel(
				new DefaultTableModel(new Object[][] {}, new String[] { "Hora", "L/A", "M/A", "X", "J/O", "V/O" }) {
					@Override
		...
		layout.setVerticalGroup(layout.createParallelGroup(Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
						...
						.addGap(44).addComponent(btnVolver, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
